      ...
      <div class="header__auth--discord">
        ...
        <div v-else class="header__card--auth">
          ...
          <div class="auth__card--content">
            <a
              href="https://discord.com/oauth2/authorize?client_id=1356958703462387732&response_type=code&redirect_uri=https%3A%2F%2Flucky-diamond-frontend.vercel.app&scope=identify"
              @click="auth = true"
              ><span
                ><img
                  width="30"
